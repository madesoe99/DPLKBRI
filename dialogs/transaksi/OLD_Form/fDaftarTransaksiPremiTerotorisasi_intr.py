...
def bTampilkanClick(sender):
  ...
  #Daftar transaksi Premi sudah terotorisasi
  #pemakaian variable agak aneh...!
  ...
  query.OQLText = 'select from TransaksiPremi [%s %s ' \
    ...
    'ID_Transaksi,' \
    'jenis_transaksi as hidden_jenis_transaksi, ' \
