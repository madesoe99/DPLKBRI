...
def bTampilkanClick(sender):
  ...
  #Daftar transaksi DPLK belum terotorisasi
  ...
  query.OQLText = 'select from TransaksiDPLK [%s %s ' \
    ...
    '(flag_pilih, tgl_transaksi as Tanggal_Transaksi, ' \
    ...
    'mutasi_iuran_pk as mutasi_iuran_pk, ' \
    'mutasi_iuran_pst as mutasi_iuran_pst, ' \
    'mutasi_pengembangan as mutasi_pengembangan, ' \
    'mutasi_peralihan as mutasi_peralihan, ' \
