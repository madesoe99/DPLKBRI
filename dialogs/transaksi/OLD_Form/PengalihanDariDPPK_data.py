...
def FormGeneralProcessData(uideflist, data):
  ...
  try:
    ...
    oP.mutasi_iuran_pst    = oP.mutasi_iuran_pk = oP.mutasi_iuran_pst = oP.mutasi_pengembangan = 0.0
    oP.mutasi_iuran_pst    = oP.saldo_iuran_pst
    oP.mutasi_iuran_pk     = oP.saldo_iuran_pk
    oP.mutasi_pengembangan = oP.saldo_pengembangan
    oP.mutasi_peralihan    = oP.saldo_peralihan


    oP.no_peserta = recNasabah.no_peserta
    oP.kode_jenis_transaksi = 'O'
