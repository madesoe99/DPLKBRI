class fOtorisasiPengalihanDariDPPKLain:
  ...
  def Form_OnFormShow(self, form, parameter):
    ...
    if self.Mode == 'view':
      ...
      form.Caption = 'Lihat Detil Pengalihan Dari DPPK Lain'
  #--

  def bReject_Click(self, button):
    if self.App.ConfirmDialog('Anda yakin membatalkan transaksi Pengalihan Dari DPPK Lain peserta %s %s?' \
