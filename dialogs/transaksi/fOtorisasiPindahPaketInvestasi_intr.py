class fOtorisasiPindahPaketInvestasi:
  ...
  def Form_OnFormShow(self, form, parameter):
    ...
    if self.Mode == 'view':
      ...
      form.Caption = 'Lihat Detil Pindah Paket Investasi'
  #--

  def bReject_Click(self, button):
    if self.App.ConfirmDialog('Anda yakin membatalkan transaksi Pindah Paket Investasi peserta %s %s?' \
