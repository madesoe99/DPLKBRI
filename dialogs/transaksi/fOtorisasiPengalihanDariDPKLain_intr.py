class fOtorisasiPengalihanDariDPKLain:
  ...
  def Form_OnFormShow(self, form, parameter):
    ...
    if self.Mode == 'view':
      ...
      form.Caption = 'Lihat Detil Pengalihan Dari DPK Lain'
  #--

  def bReject_Click(self, button):
    if self.App.ConfirmDialog('Anda yakin membatalkan transaksi Pengalihan Dari DPK Lain peserta %s %s?' \
