...
def ContructSumValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, \
  ...
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  oFile.write('		<td width="35%" align="left"   style="border-style: none; border-width: medium"><font size="2">Akumulasi Penarikan Tahun '+config.FormatDateTime('yyyy',hingga_tanggal)+' </font></td>\n')
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
...
#   oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  oFile.write('		<td width="35%" align="left"   style="border-style: none; border-width: medium"><font size="2">Total Hasil Investasi </font></td>\n')
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  ...
  oFile.write('		<td width="15%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, sumBagiHasil) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
...
def ConstructReportValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, saldo_awal, oFile):
  ...
  oFile.write('	<tr>\n')
  oFile.write('		<td width="10%" align="center" style="border-style: solid; border-width: 1px"><font size="2"><b>TANGGAL<br>\n')
  oFile.write('		(dd/mm/yyyy)</b></font></td>\n')
  oFile.write('		<td width="10%" align="center" style="border-style: solid; border-width: 1px"><font size="2"><b>MUTASI</b></font></td>\n')
  oFile.write('		<td width="30%" align="center" style="border-style: solid; border-width: 1px"><font size="2"><b>TRANSAKSI</b></font></td>\n')
#  oFile.write('		<td width="40%" align="center" style="border-style: solid; border-width: 1px"><b>KETERANGAN</b></td>\n')
  oFile.write('		<td width="20%" align="center" style="border-style: solid; border-width: 1px"><font size="2"><b>NOMINAL</b></font></td>\n')
  ...
  while not resSQL.Eof:
    ...
    if resSQL.kode_jenis_transaksi not in ['M','X']:
      ...
      if resSQL.mutasi_total < 0.0 and resSQL.kode_jenis_transaksi == 'K':
         ...
         if resSQL.kode_jenis_transaksi == 'G':
            ...
            transaksi = '<font size="2">%s</font>' % string.capwords((resSQL.keterangan))
    else:
    ...
    oFile.write('		<td width="10%" align="center" style="border-style: solid; border-width: 1px"><font size="2">'+mutasi+'</font></td>\n')
...
def CreateReport(config, parameter, returnpacket):
  ...
  oNopeserta = config.CreatePObjImplProxy('NasabahDPLK')
  oNopeserta.key = parameter.FirstRecord.no_peserta
  
  if oNopeserta.kode_nasabah_corporate in ('BMI','MUTUAL','HITTS','HITSS'):
     oUser = config.CreatePObjImplProxy('UserApp')
     oUser.Key = userid
     userid = string.upper(userid)
  
     if userid in ('YUNIAR','NUR ALFA','NURALFA','ADE HERMAN','SYARIFDPLK'):
