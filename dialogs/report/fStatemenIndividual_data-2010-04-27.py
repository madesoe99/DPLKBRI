...
def ContructSumValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, \
  ...
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  oFile.write('		<td width="30%" align="left"   style="border-style: none; border-width: medium"><font size="2">Akumulasi Iuran Peserta</font></td>\n')
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, sumIuranPst) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  oFile.write('		<td width="30%" align="left"   style="border-style: none; border-width: medium"><font size="2">Akumulasi Iuran Pemberi Kerja</font></td>\n')
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, sumIuranPK) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
...
#   oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  oFile.write('		<td width="30%" align="left"   style="border-style: none; border-width: medium"><font size="2">Hasil Investasi</font></td>\n')
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
...
def ConstructReportValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, saldo_awal, oFile):
  ...
  oFile.write('		<td width="25%" align="center" style="border-style: solid; border-width: 1px"><b>TRANSAKSI</b></td>\n')
  oFile.write('		<td width="20%" align="center" style="border-style: solid; border-width: 1px"><b>DEBET</b></td>\n')
#  oFile.write('		<td width="40%" align="center" style="border-style: solid; border-width: 1px"><b>KETERANGAN</b></td>\n')
  oFile.write('		<td width="20%" align="center" style="border-style: solid; border-width: 1px"><b>KREDIT</b></td>\n')
    ...
    if resSQL.kode_jenis_transaksi != 'M':
      ...
      if resSQL.mutasi_total < 0.0 and resSQL.kode_jenis_transaksi in ['K']:
         ...
         if resSQL.kode_jenis_transaksi in ['G']:
            transaksi = '<font size="2">%s %s</font>' % (dictJenisTransaksiDPLK[resSQL.kode_jenis_transaksi], resSQL.keterangan)
         else:
