...
def FormGeneralSetData(uideflist, uiname, objdata):
  ...
  try:
    ...
    loginMessageTextFile = config.SysVarIntf.GetStringSysVar('MESSAGING','WarningCoreBankingTextFile')
...
def FormGeneralProcessData(uideflist, data):
  ...
  try:
    ...
    raise Exception, '\nProses Error' + 'Penyimpanan Pesan Peringatan Koneksi CoreBanking gagal!'
