...
def IsiExcel(app, workbook, res):
    ...
    ds1 = res.Packet.proporsipaket
#     IsiProporsiPaket(ds1, workbook, 'Sheet1')
...
def IsiProporsiPaket(ds1, workbook, worksheetname):
    n = ds1.RecordCount; i = 0
    workbook.ActivateWorksheet(worksheetname)
    while i < n:
      rec = ds1.GetRecord(i)
      workbook.SetCellValue(i+4,8, rec.prosentase)
      i += 1
