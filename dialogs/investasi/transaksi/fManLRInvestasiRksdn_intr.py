...
def FormShow(form, parameter):
  ...
  uipTransLRInvestasi.id_investasi = uipTransLRInvestasi.GetFieldValue('LInvestasi.id_investasi')
...
def btnPrintClick(sender):
  ...
  uipTransLRInvestasi = form.GetUIPartByName('uipTransLRInvestasi')
  form.CommitBuffer()
  CetakAdvis(app, uipTransLRInvestasi)

def CetakAdvis(app, uipTransLRInvestasi):
  lHeader = ['ID Reksadana', 'Pihak Ketiga', 'Paket Investasi', \
  ...
  sData = '|'.join(lData)
  ph = app.CreateValues(['nama_advis','Koreksi Hasil Investasi EQ'],['sHeader',sHeader],['sData',sData],['inputer',uipTransLRInvestasi.user_id])
