...
def btnShowClick(sender):
  ...
  if date_ltd:
    ...
    qSaham.SetParameter('dateFrom', dateFrom)
    qSaham.SetParameter('dateUntil_tmrw', tmrw_dateUntil)
  ...
  qSaham.SetParameter('status_ltd', status_ltd)
  qSaham.SetParameter('status', status)
