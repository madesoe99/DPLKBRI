...
def CetakAdvis(app, uipTransPiutangInvestasi):
  lHeader = ['ID Investasi', 'Pihak Ketiga', 'Paket Investasi', \
  ...
  sData = '|'.join(lData)
  ph = app.CreateValues(['nama_advis','Koreksi Pokok Investasi FIX'],['sHeader',sHeader],['sData',sData],['inputer',uipTransPiutangInvestasi.user_id])
