...
def CetakAdvis(app, uipRegisterDeposito):
  lHeader = ['No. Batch','Rekening Deposito', 'No. Bilyet', 'Pihak Ketiga',\
             'Nisbah', 'Tgl Buka', 'Jangka Waktu', 'Jatuh Tempo On Call',\
  ...
  lData = [str(uipRegisterDeposito.GetFieldValue('LTransactionBatch.no_batch')),\
           str(uipRegisterDeposito.rekening_deposito),\
           ...
           app.ModLibUtils.FormatFloat(',0.00 %',uipRegisterDeposito.nisbah or 0.0),\
           str(sTgl),\
