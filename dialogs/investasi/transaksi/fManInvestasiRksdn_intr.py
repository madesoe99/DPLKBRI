...
def btnOKClick(sender):
  ...
  if uipTransPiutangInvestasi.mode == 'viewdoc':
    ...
    if uipTransPiutangInvestasi.mode not in ['view','auth']:
      ...
      if dlg: CetakAdvis(app, uipTransPiutangInvestasi)
...
def CetakAdvis(app, uipTransPiutangInvestasi):
  ...
  sData = '|'.join(lData)
  ph = app.CreateValues(['nama_advis','Koreksi Manual Investasi EQ'],['sHeader',sHeader],['sData',sData],['inputer',uipTransPiutangInvestasi.user_id])
