...
def FormShow(form, parameter):
  ...
  #form.GetControlByName('pPekerjaan.pekerjaan_orang_tua').ControlCaption = ''
  #form.GetControlByName('pPekerjaan.penghasilan_orang_tua').ControlCaption = ''
...
def nasabah_korporatClick(sender):
  ...
  if gReady != 0:
    ...
    if sender.Checked:
      ...
      #SetControlsEnability(form.GetPanelByName('pPekerjaan'), , -2147483624)
      #SetControlsVisibility(uipRegisterNasabahRekening, 1, "alamatKantor")
      ...
      #SetControlsEnability(form.GetPanelByName('pPekerjaan'), -1, 0)
...
## Tambahan By Ade herman ------ 2010-12-31----#
def pekerjaanClick(sender):
  form = sender.OwnerForm
  ...
  index = sender.OwnerForm.GetControlByName('pPekerjaan.Pekerjaan').ItemIndex
  if index in [4,7] :

    form.GetControlByName('pPekerjaan.nama_perusahaan').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_jalan').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_kelurahan').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_kecamatan').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_kota').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_propinsi').visible = \
    form.GetControlByName('pPekerjaan.alamat_kantor_kode_pos').visible = \
    form.GetControlByName('pPekerjaan.LJenisUsaha').visible = \
    form.GetControlByName('pPekerjaan.LKepemilikan').visible = 0

    form.GetControlByName('pPekerjaan.pekerjaan_orang_tua').ControlCaption = 'Pekerjaan Orang Tua'
    form.GetControlByName('pPekerjaan.penghasilan_orang_tua').ControlCaption = 'Penghasilan Orang Tua'

    form.GetControlByName('pPekerjaan.datasuami').Visible = \
    form.GetControlByName('pPekerjaan.nama_orang_tua').Visible = \
    form.GetControlByName('pPekerjaan.pekerjaan_orang_tua').visible = \
    form.GetControlByName('pPekerjaan.nama_orang_tua').Visible = \
    form.GetControlByName('pPekerjaan.nama_perusahaan1').Visible = \
    form.GetControlByName('pPekerjaan.penghasilan_orang_tua').Visible = 1
    ...
    form.GetControlByName('pPekerjaan.alamat_kantor_kode_pos').visible = \
    form.GetControlByName('pPekerjaan.LJenisUsaha').visible = \
    form.GetControlByName('pPekerjaan.LKepemilikan').visible = 1
    ...
    form.GetControlByName('pPekerjaan.nama_orang_tua').Visible = \
    form.GetControlByName('pPekerjaan.nama_perusahaan1').Visible = \
    form.GetControlByName('pPekerjaan.penghasilan_orang_tua').Visible = 0
...
def btnOKClick(sender):
  ...
  form.ShowMessage('Setelah Registrasi Customer Service langsung '\
      'lakukan otorisasi pada Menu Nasabah, Daftar Register Peserta Baru, '\
      'klik kanan Otorisasi hasil register peserta !!!')
