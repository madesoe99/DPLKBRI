...
def ApplyParameter(form):
  qMasterKartuDPLK = form.GetPanelByName('qMasterKartuDPLK')
  qMasterKartuDPLK.DisplayData()

def RefreshQuery(form):
  qMasterKartuDPLK = form.GetPanelByName('qMasterKartuDPLK')
  qMasterKartuDPLK.Refresh()

def SetQueryParameter(form, paramname, paramvalue):
  qMasterKartuDPLK = form.GetPanelByName('qMasterKartuDPLK')
  qMasterKartuDPLK.SetParameter(paramname, paramvalue)
