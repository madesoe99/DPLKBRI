...
def ApplyParameter(form):
  qMonitoringPendingAlkhairat = form.GetPanelByName('qMonitoringPendingAlkhairat')
  qMonitoringPendingAlkhairat.DisplayData()

def RefreshQuery(form):
  qMonitoringPendingAlkhairat = form.GetPanelByName('qMonitoringAlkhairat')
  qMonitoringPendingAlkhairat.Refresh()

def SetQueryParameter(form, paramname, paramvalue):
  qMonitoringPendingAlkhairat = form.GetPanelByName('qMonitoringPendingAlkhairat')
  qMonitoringPendingAlkhairat.SetParameter(paramname, paramvalue)
...
def bPetunjukClick(sender):
  ...
  '\nKeterangan       --> Isian yang ada pada Formulir alkhairat '\
  '\nTgl Input            --> Proses penginputan pending peserta alkhairat')
