...
def ApplyParameter(form):
  qHistoriBukuDPLK = form.GetPanelByName('qHistoriBukuDPLK')
  qHistoriBukuDPLK.DisplayData()

def RefreshQuery(form):
  qHistoriBukuDPLK = form.GetPanelByName('qHistoriBukuDPLK')
  qHistoriBukuDPLK.Refresh()

def SetQueryParameter(form, paramname, paramvalue):
  qHistoriBukuDPLK = form.GetPanelByName('qHistoriBukuDPLK')
  qHistoriBukuDPLK.SetParameter(paramname, paramvalue)
