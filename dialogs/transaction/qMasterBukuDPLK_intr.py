...
def ApplyParameter(form):
  qMasterBukuDPLK = form.GetPanelByName('qMasterBukuDPLK')
  qMasterBukuDPLK.DisplayData()

def RefreshQuery(form):
  qMasterBukuDPLK = form.GetPanelByName('qMasterBukuDPLK')
  qMasterBukuDPLK.Refresh()

def SetQueryParameter(form, paramname, paramvalue):
  qMasterBukuDPLK = form.GetPanelByName('qMasterBukuDPLK')
  qMasterBukuDPLK.SetParameter(paramname, paramvalue)
