/* Altering table for class HistoriGiro */

ALTER TABLE HISTORIGIRO
  ADD ISTRANSAKSICREATED VARCHAR(1);

/* Altering table for class HistoriGiroHarian */

ALTER TABLE HISTORIGIROHARIAN
  ADD ISRECONCILED VARCHAR(1),
  ISTRANSACTIONPROCEED VARCHAR(1);

/* Altering table for class IuranPendaftaran */

ALTER TABLE IURANPENDAFTARAN
  ADD REF_COREBANKING VARCHAR(20);

/* Altering table for class TransaksiDPLK */

ALTER TABLE TRANSAKSIDPLK
  ADD REF_COREBANKING VARCHAR(20);

/* Altering table for class TransaksiInvestasi */

ALTER TABLE TRANSAKSIINVESTASI
  ADD REF_COREBANKING VARCHAR(20);

/* Altering table for class TransaksiPremi */

ALTER TABLE TRANSAKSIPREMI
  ADD REF_COREBANKING VARCHAR(20);
