...
ALTER TABLE [dbo].[PENGALIHANDARIDPLKLAIN]
ALTER COLUMN [KODE_DP] varchar(50)

/* Migrating column for class PengalihanKeDPLKLain */

ALTER TABLE [dbo].[PENGALIHANKEDPLKLAIN]
ALTER COLUMN [KODE_DP] varchar(50)

/* Altering table for class RegEditNasabahRekening */

ALTER TABLE REGEDITNASABAHREKENING
  ADD NO_IDENTITAS_DIRI VARCHAR(15);
...
ALTER TABLE REGISTERUBAHALAMAT
  ADD ALAMAT_SURAT_JALAN2 INTEGER,
  ALAMAT_PROPINSI VARCHAR(50),
  ALAMAT_SURAT_TELEPON VARCHAR(30),
  ALAMAT_SURAT_TELEPON2 VARCHAR(30);
