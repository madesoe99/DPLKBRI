/* Migrating column for class LDP */

ALTER TABLE dbo.LDP ADD TEMP_COL VARCHAR(30);

UPDATE dbo.LDP SET TEMP_COL = ALAMAT_DP;
COMMIT;

ALTER TABLE dbo.LDP DROP ALAMAT_DP;
ALTER TABLE dbo.LDP ADD ALAMAT_DP VARCHAR(50);

UPDATE dbo.LDP SET ALAMAT_DP = TEMP_COL;
COMMIT;

ALTER TABLE dbo.LDP DROP TEMP_COL;
