/* Altering table for class RegisterAnuitas */

ALTER TABLE REGISTERANUITAS
  ADD NOMINAL_ANUITAS DOUBLE PRECISION;

/* Altering table for class RekeningAnuitas */

ALTER TABLE REKENINGANUITAS
  ADD NOMINAL_ANUITAS DOUBLE PRECISION;
