...
ALTER TABLE HISTORIUBAHALAMAT
  ADD ALAMAT_PROPINSI VARCHAR(50),
...
ALTER TABLE NASABAHDPLK
  ADD ALAMAT_SURAT_JALAN2 VARCHAR(200),
  NO_IDENTITAS_DIRI VARCHAR(20),
...
/* Migrating column for class PengalihanDariDPLKLain */

ALTER TABLE dbo.PENGALIHANDARIDPLKLAIN ADD TEMP_COL VARCHAR(30);

UPDATE dbo.PENGALIHANDARIDPLKLAIN SET TEMP_COL = KODE_DP;
COMMIT;

ALTER TABLE dbo.PENGALIHANDARIDPLKLAIN DROP KODE_DP;
ALTER TABLE dbo.PENGALIHANDARIDPLKLAIN ADD KODE_DP VARCHAR(50);

UPDATE dbo.PENGALIHANDARIDPLKLAIN SET KODE_DP = TEMP_COL;
COMMIT;

ALTER TABLE dbo.PENGALIHANDARIDPLKLAIN DROP TEMP_COL;

/* Migrating column for class PengalihanKeDPLKLain */

ALTER TABLE dbo.PENGALIHANKEDPLKLAIN ADD TEMP_COL VARCHAR(30);

UPDATE dbo.PENGALIHANKEDPLKLAIN SET TEMP_COL = KODE_DP;
COMMIT;

ALTER TABLE dbo.PENGALIHANKEDPLKLAIN DROP KODE_DP;
ALTER TABLE dbo.PENGALIHANKEDPLKLAIN ADD KODE_DP VARCHAR(50);

UPDATE dbo.PENGALIHANKEDPLKLAIN SET KODE_DP = TEMP_COL;
COMMIT;

ALTER TABLE dbo.PENGALIHANKEDPLKLAIN DROP TEMP_COL;

/* Altering table for class RegEditNasabahRekening */

ALTER TABLE REGEDITNASABAHREKENING
  ADD NO_IDENTITAS_DIRI VARCHAR(20);
...
INSERT INTO Enum_Varchar (Enum_Name, Enum_Value, Enum_Description) VALUES ('eKirimStatemen', 'R', 'Rumah (Alamat Surat)');
