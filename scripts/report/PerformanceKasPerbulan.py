...
def ConstructReportHeader(config, strTanggalAwal, strTanggalAkhir, nama_bulan, oFile):
  ...
  oFile.write('		<p align="LEFT"><font size="3" color="#008000"><b>LAPORAN PERFORMANCE KANTOR KAS PERBULAN </b></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  ...
  oFile.write('		<b>KANTOR KAS</b></td>\n')
  oFile.write('		<td width="18%" rowspan = "3" align="center" style="border-style: solid; border-width: 1px; " bgcolor="#CC6699">\n')
  oFile.write('		<b>CABANG INDUK</b></td>\n')
...
def strSQLCabang(config):
  return \
    'select AREA,BRANCH_CODE,BRANCHNAME,BRANCHSTATUS,MASTERBRANCH_CODE,TGL_BUKA '\
    'from BRANCHLOCATION '\
    'WHERE BRANCHSTATUS = \'K\' '\
    'ORDER BY AREA, MASTERBRANCH_CODE, BRANCH_CODE';
...
def ConstructReportValues(config, strSQL, tgl_transaksi_awal, tgl_transaksi_plus, blnAwl, blnAkh, oFile):
  ...
  dictKodeCabang = {'A001':'AREA SUMBAGUT',\
                    ...
                    'A011':'KPO',\
                    'A999':'OTHERS'}
  dictStatus = {'S':120,'B':240 , 'K':60}

  resSQL.First()
  while not resSQL.Eof:
  
  
    oR = config.CreatePObjImplProxy('BRANCHLOCATION')
    oR.Key = resSQL.MASTERBRANCH_CODE
    ...
    if resSQL.area == 'A000':
       ...
       if area <> resSQL.area:
          if no_urut == 1:
             oFile.write('	<tr>\n')
             oFile.write('		<td width="7%" colspan="14" style="border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px" bgcolor="#CC6699" height="22">\n')
       ...
       oFile.write('		<td width="18%" style="border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px" bgcolor="'+ bgcolor +'" height="22">\n')
       oFile.write('		<p align="left">'+ resSQL.MASTERBRANCH_CODE +' - '+cabInduk +'</td>\n')
