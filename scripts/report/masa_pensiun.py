...
def ConstructReportHeader(config, isDipercepat, tanggal_pensiun_awal, tanggal_pensiun_akhir, oFile):
  ...
  oFile.write('		<td width="25%" align="center" style="border-style: solid; border-width: 1px; " bgcolor="#CC6699" rowspan="2">\n')
  oFile.write('		<p style="margin-top: 0; margin-bottom: 0"><b>NAMA PERUSAHAAN</b></td>\n')
...
def strSQLMasaPensiun(config, isDipercepat, tanggal_pensiun_awal, tanggal_pensiun_akhir_plus):
  ...
  return \
    ...
    '  , isnull(nama_perusahaan,\'\') nama_perusahaan '\
...
def ConstructReportValues(config, strSQL, oFile):
  ...
  while not resSQL.Eof:
    ...
    oFile.write('		<td width="25%" style="border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px" bgcolor="'+ bgcolor +'">'+ resSQL.nama_perusahaan +'</td>\n')
...
def ConstructReportTrailer(config, totAkumIuran, totAkumPeralihan, totAkumPengembangan, oFile):
  oFile.write('	<tr>\n')
  oFile.write('		<td width="70%" style="border-left:1px solid #000000; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px" align="right" colspan="7" bgcolor="#CC6699">\n')
