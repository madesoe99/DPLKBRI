...
def ConstructReportHeader(config, namaTransaksi, strTanggalAwal, strTanggalAkhir, oFile):
  ...
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="100%" colspan="8" style="border-style: none; border-width: medium">\n')
...
def ConstructReportTrailer(config, totJmlMutasi, oFile):
  oFile.write('	<tr>\n')
  oFile.write('		<td width="85%" style="border-left:1px solid #000000; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px" align="right" colspan="7" bgcolor="#CC6699">\n')
...
def WriteToFile(config, parameter, oFile):
  ...
  strSQL = strSQLDaftarTransaksi(config, tgl_transaksi_awal, tgl_transaksi_akhir + 1, lsJenis)
