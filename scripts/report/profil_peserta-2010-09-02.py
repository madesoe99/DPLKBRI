...
def GetValuesFromKlasifikasi(config, klasifikasi):
  if klasifikasi == 'J':
    ...
    strSQL = \
      'select k.kode_jenis_usaha kode, k.nama_jenis_usaha nama, count(no_peserta) jumlah '\
      'from jenisusaha k, nasabahdplk n '\
      'where k.kode_jenis_usaha = n.kode_jenis_usaha '\
    ...
    name = 'Nama Propinsi'
    strSQL = \
      'select k.kode_propinsi kode, k.nama_propinsi nama, count(no_peserta) jumlah '\
      'from daerahasal k, nasabahdplk n '\
      'where k.kode_propinsi = n.kode_propinsi '\
    ...
    name = 'Keterangan'
    strSQL = \
      'select k.kode_pemilikan kode, k.keterangan nama, count(no_peserta) jumlah '\
      'from kepemilikan k, nasabahdplk n '\
      'where k.kode_pemilikan = n.kode_pemilikan '\
    ...
    name = 'Nama Kelompok'
    strSQL = \
      'select k.kode_kelompok kode, k.nama_kelompok nama, count(no_peserta) jumlah '\
      'from kelompok k, nasabahdplk n '\
