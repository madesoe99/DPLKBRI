...
def ConstructReportHeader(config, strTanggalAkhir, oFile):
  ...
  oFile.write('\n')
  oFile.write('<head>\n')
  oFile.write('<title>Laporan Posisi Dana PerPaket Corporate</title>\n')
  oFile.write('\n')
  ...
  oFile.write('		<p align="center"><font size="3" color="#008000"><b>POSISI DANA PERPAKET</b></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="100%" colspan="7" style="border-style: none; border-width: medium">\n')
  oFile.write('		<font color="#008000"><b>POSISI '+ string.upper(strTanggalAkhir) +'</b></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
...
def strSQLSumValues(config, tgl_transaksi_akhir_plus):
  return \
...
def WriteToFile(config, parameter, oFile):
  ...
  strSQL = strSQLSumValues(config, tgl_transaksi_akhir + 1)
