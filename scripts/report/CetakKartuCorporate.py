...
def ConstructReportHeader(config, oFile):
  ...
  oFile.write('\n')
  oFile.write('<head>\n')
  oFile.write('<title>Data Cetak Kartu Perusahaan</title>\n')
  oFile.write('\n')
  ...
  oFile.write('		<p align="center"><font size="3" color="#008000"><b>CETAK KARTU PERUSAHAAN</b></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
...
def strSQLDaftarPeserta(config, corporate_code):
  return \
    'select n.no_peserta '\
    '  , n.nama_lengkap '\
    '  , r.kode_cab_daftar '\
...
def WriteToFile(config, parameter, oFile):
  corporate_code = parameter.FirstRecord.corporate_code
  ...
  strSQL = strSQLDaftarPeserta(config, corporate_code)
...
def CreateReport(config, parameter, returnpacket):
  sBaseFileName = 'Data Cetak Kartu Perusahaan.htm'
