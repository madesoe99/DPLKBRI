...
def ConstructReportValues(config, strSQL, oFile):
  ...
  while not resSQL.Eof:
    ...
    oFile.write('		<td width="20%" style="border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px" bgcolor="'+ bgcolor +'" height="22">'+ oPenarikan.LRekeningDPLK.LNasabahDPLK.nama_lengkap +'</td>\n')
...
def ConstructReportTrailer(config, totJmlTarik, totBiayaNormal, totBiayaPHK, totPajak, totNominalTarikAkhir, oFile):
  oFile.write('	<tr>\n')
  oFile.write('		<td width="55%" style="border-left:1px solid #000000; border-right-style:solid; border-right-width:1px; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px" align="right" colspan="6" bgcolor="#CC6699">\n')
