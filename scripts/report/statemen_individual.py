...
def ConstructReportHeader(config, no_peserta, dari_tanggal, hingga_tanggal, saldo_awal, oFile):
  ...
  alamat = '<font size="2">%s %s</font> RTRW: <font size="2">%s</font>' % (oNasabahDPLK.alamat_jalan, oNasabahDPLK.alamat_jalan2,\
    oNasabahDPLK.alamat_rtrw)
  kota_kodepos = '%s %s' % (oNasabahDPLK.alamat_kota, oNasabahDPLK.alamat_kode_pos)
  paket_investasi = '<font size="2">(%s) %s</font>' % (oNasabahDPLK.LRekeningDPLK.LPaketInvestasi.kode_paket_investasi, oNasabahDPLK.LRekeningDPLK.LPaketInvestasi.nama_paket_investasi)
...
def ContructSumValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, \
  ...
  sSQL = 'select t.KODE_JENIS_TRANSAKSI,\
          ...
          where t.TGL_TRANSAKSI >= \'%s\' and\
                ...
                t.ISCOMMITTED = \'T\'\
          group by t.KODE_JENIS_TRANSAKSI'\
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(dictJenisTransaksi['V'])) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(dictJenisTransaksi['W'])) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(dictJenisTransaksi['E'])) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(dictJenisTransaksi['D'])) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(dictJenisTransaksi['C'])) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, dictJenisTransaksi['I']) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, dictJenisTransaksi['O']) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
  ...
  oFile.write('		<td width="2%"  align="center" style="border-style: none; border-width: medium"><font size="2">:</font></td>\n')
  oFile.write('		<td width="20%" align="right"  style="border-style: none; border-width: medium"><font size="2">'+ moduleapi.FormatFloatStd(config, dictJenisTransaksi['P']) +'</font></td>\n')
  oFile.write('		<td width="28%" align="left"  style="border-style: none; border-width: medium"><font size="2"></font></td>\n')
  oFile.write('	</tr>&nbsp;\n')
  oFile.write('	<tr>\n')
  oFile.write('		<td width="20%" align="left"   style="border-style: none; border-width: medium"></td>\n')
...
def ConstructReportValues(config, no_peserta, str_dari_tanggal, str_hingga_tanggal_plus, saldo_awal, oFile):
  ...
  while not resSQL.Eof:
    ...
    saldo_curr += resSQL.mutasi_total

    oFile.write('	<tr>\n')
    oFile.write('		<td width="15%" align="center" style="border-style: solid; border-width: 1px"><font size="2">'+ tanggal +'</font></td>\n')
    oFile.write('		<td width="15%" align="center" style="border-style: solid; border-width: 1px"><font size="2">'+ mutasi +'</font></td>\n')
    oFile.write('		<td width="30%" align="left" style="border-style: solid; border-width: 1px"><font size="2">'+ transaksi +'</font></td>\n')
    oFile.write('		<td width="20%" align="right" style="border-style: solid; border-width: 1px"><font size="2">'+ moduleapi.FormatFloatStd(config, abs(resSQL.mutasi_total)) +'</font></td>\n')
