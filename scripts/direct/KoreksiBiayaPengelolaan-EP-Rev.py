...
file_user = 'Pertamina-EP-Reverse.txt'
SEP = '|'
...
def CreateTransaksi(config, val):
  ...
  o.mutasi_iuran_pk = 0
  o.mutasi_iuran_pst = float(val[1])
  o.mutasi_pengembangan = float(val[2])
  ...
  oR.akum_dana_iuran_pst = oR.akum_dana_iuran_pst + float(val[1])
  oR.akum_dana_pengembangan = oR.akum_dana_pengembangan + float(val[2])
