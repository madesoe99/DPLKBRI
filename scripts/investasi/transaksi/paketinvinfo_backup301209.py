...
def getNominalGiroPaket(config, kode_paket_investasi):
...
def getPaketInfo(config, kode_paket_investasi, kode_jns_investasi):
  ...
  nominalGiro = getNominalGiroPaket(config, kode_paket_investasi) or 0.0
  ...
  dpkTersedia = dpkPaket - dpkDiinvestasikan
